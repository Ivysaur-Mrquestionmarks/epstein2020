...
NDiplomacy = {
	...
	MAX_SCORE_DIFF_TO_CHANGE_AUTONOMY = 4000,			-- The max diff between current freedom score and the cap for next or previous level allowed for changing
